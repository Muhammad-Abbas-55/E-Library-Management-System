                            ...
                            <div class="booksmedia-detail-box">
                              <div class="table-tabs" id="responsiveTabs">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><b class="arrow-up"></b><a data-toggle="tab" href="#sectionA">Magazines</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionZ">Research Paper</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionB">PDF-Book</a></li>
        ...
        <ul>
            <li class="bg-yellow" style="border-color: black; border-style: solid;">
                <div class="feature-box">
                    <i class="red"></i>
                    <h3>{{ $ma->title }}</h3>
                    <p><strong>Category: </strong>{{ $ma->category->c_name }}</p>
                    <p><strong>Type:</strong>Magazine</p>

                    <a class="red" href="read_ebook/{{ $ma->id }}">
