...
@section("title","Research Paper Index")
            ...
            allowClear: true
                   ...
                   <section class="welcome-section">
                            ...
                            <div class="booksmedia-detail-box">
                              <div class="table-tabs" id="responsiveTabs">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><b class="arrow-up"></b><a data-toggle="tab" href="#sectionA">Research Paper</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionZ">Magazines</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionB">E-Books</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionC">Audio Books</a></li>
                    ...
                    @endforeach
                                    ...
                                    <div class="tab-content">
                                        <div id="sectionZ" class="tab-pane fade in">
                                        <h5>Magazine</h5>
                                             <div  class="table-responsive" style="overflow-x:auto;">
                                            <table class="table table-bordered">         
                                               <tr>
...
<section class="features">
    ...
    <div class="container">
        @foreach($pap as $pa)
        <ul>
            <li class="bg-yellow" style="border-color: black; border-style: solid;">
                <div class="feature-box">
                    <i class="red"></i>
                    <h3>{{ $pa->title }}</h3>
                    <p><strong>Category: </strong>{{ $pa->category->c_name }}</p>
                    <p><strong>Type:</strong>Research Paper</p>

                    <a class="red" href="read_ebook/{{ $pa->id }}">
