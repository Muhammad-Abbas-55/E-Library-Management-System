...
@section("head")
    <li><a href="{{ route('ebookindex') }}">E-Book List</a></li>Search
                                            ...
                                            <form action="{{ route('e_book.search') }}" method="get">
                                                <div class="col-md-8 col-sm-6">
                                                    <div class="form-group">
                                                        <label class="sr-only" for="query">Search by Keyword</label>
                                                        <input class="form-control" placeholder="Search by Keyword" id="query" name="query" type="search">
                                                    </div>
                                                </div>
                                            ...
                                            <form action="{{ route('a_search.ebook') }}" method="get">
                                                <div class="col-md-8 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" placeholder="Search by Auther Name" id="a_query" name="a_query" type="search">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-sm-6">
                                                    <div class="form-group">
