        ...
        <div id="content" class="site-content">
            <div id="primary" class="content-area">
                                    ...
                                    <div class="booksmedia-detail-box">
                                        <div class="single-book-box">                                                
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="Book" style=" width: 350px; height: 562px" src="{{asset($book->b_image)}} "/>                                                    
                                            </div>
                                <div class="post-detail">
                                    <header class="entry-header">
                                        <h2 class="entry-title">{{ $book->b_title }}</h2>
                                            <ul>      
                                               <li><strong>Book Title :</strong> {{ $book->b_title }}</li>
                                               <li><strong>Book Edition :</strong> {{ $book->b_edition }}</li>
                                               <li><strong>Book ISBN No :</strong> {{ $book->b_isbn }}</li>
                ...
                @endforeach
                                              ...
                                              <li><strong>Book Serial No :</strong>
                                              ...
                                              <li><strong>Shelf No :</strong>
                                               ...
                                               <li><strong>Publish Date :</strong> {{ $book->p_date }}</li>
                                               <li><strong>Publisher Country :</strong> {{ $book->country->country }}</li>
                                               <li><strong>Book Category :</strong> {{ $book->category->c_name }}</li>
                                               <li><strong>Total Copies :</strong> {{ $book->total_copies }}</li>
                                               <li><strong>Available Copies :</strong> {{ $book->avalible_copies }}</li>
                                               <li><strong>Book Price :</strong> {{ $book->b_price }}</li>
                                        ...
                                        <ul class="detail-page-listing">
                                            <li><strong>Length:</strong> {{ $book->length }} Pages</li>
                                        </ul>
                                    </div>
                                </div>
