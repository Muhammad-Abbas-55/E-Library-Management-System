                            ...
                            <div class="row">
                                <div class="col-md-8">             
                                    <aside id="secondary" class="sidebar widget-area" data-accordion-group>
                                            ...
                                            <div data-content>
                                                <div data-accordion>
                                                    <h5 class="widget-sub-title" data-control>Search By Categories</h5>
                            ...
                            <div class="booksmedia-detail-box">
                              <div class="table-tabs" id="responsiveTabs">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><b class="arrow-up"></b><a data-toggle="tab" href="#sectionA">E-Books</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionZ">Research Paper</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionB">Audio Books</a></li>
...
<section class="features">
    ...
    <div class="container">
        @foreach($pdf as $pd)
        <ul>
            <li class="bg-light-green" style="border-color: black; border-style: solid;">
                <div class="feature-box">
                    <i class="light-green"></i>
                    <h3>{{ $pd->title }}</h3>
                    <p><strong>Category: </strong>{{ $pd->category->c_name }}</p>
                    <p><strong>Type:</strong>eBook</p>

                    <a class="light-green" href="read_ebook/{{ $pd->id }}">
