                            ...
                            <div class="booksmedia-detail-box">
                              <div class="table-tabs" id="responsiveTabs">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><b class="arrow-up"></b><a data-toggle="tab" href="#sectionA">Videos</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionZ">Research Paper</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionB">PDF-Books</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionC">Audio Books</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionD">Magazines</a></li>
                                    </ul>
...
<section class="features">
    ...
    <div class="container">
        @foreach($vid as $vi)
        <ul>
            <li class="bg-blue" style="border-color: black; border-style: solid;">
                <div class="feature-box">
                    <i class="blue"></i>
                    <h3>{{ $vi->title }}</h3>
                    <p><strong>Category: </strong>{{ $vi->category->c_name }}</p>
                    <p><strong>Type:</strong>DVDs</p>

                    <a class="blue" href="read_ebook/{{ $vi->id }}">
