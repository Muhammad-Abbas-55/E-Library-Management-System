...
<!-- 
                ...
                <div>
                          {{$author->a_name}}
                          @foreach($author->book as $bok)
                          	<div>
	                          	{{$bok->b_title}} ( {{$bok->category->c_name}} )
                          	</div>
                          @endforeach
                </div>
                @endforeach -->
      ...
      $("#a_query").select2({
           ...
           <?php $no=1; ?>
                ...
                @foreach($authors as $author)                
                	...
                	<tr>
                                                    <td>{{ $no++ }}</td>
                                                     <td><img src="{{asset($bok->b_image)}}" width="80px" height="80px"></td>

                                                    <td><a href="bookdetails/{{ $bok->id }}"><strong>{{$bok->b_title}}</strong></a></td>
                                                    <td>{{$bok->b_edition}}</td>
                                                    <td>{{$bok->b_price}}</td>
                                                    <td>{{$bok->b_isbn}}</td>
                                                    <td>
