	...
	<div class="row">
		<div class="col-md-7"> 
			...
			<a href="{{ route('book.exportpdf') }}">
				<button class="button button2" style="background-color: #008CBA; margin: 4px 2px; text-align: center; text-decoration: none; font-size: 15px; padding: 8px 3.5%; color: white; border-radius: 12%; border-radius: 1%;">Export via PDF
				</button>
			</a>
				...
				<table class="table" id="customers">
					...
					<tr>
						...
						<a href="book_show/{{ $book->id }}">
							<button class="button button2"><i class="fa fa-eye" style="font-size: 16px; padding: -5px -9px; margin: -2px -3px; border-radius: 100%" ></i></button>
						</a>
