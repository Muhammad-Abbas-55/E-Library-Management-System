...
<!-- 	<div class="row">
		<div class="col-md-6">
			<a href="{{ route('bookissue.reportstf') }}">
				<button class="button button2" type="submit" style="font-size: 16px; float: left; margin-top: 3.5px; ">Book Issued Report </button>
			</a>
		</div>

		<div class="col-md-5">
			<form type="get" action="{{ route('bookissue.searchstf') }}">	
	...
	<div class="row">
		<div class="col-md-12 text-center"> 
			...
			@foreach($staff as $bookiss)
				<h3>Book Issued to: {{$bookiss->name}}</h3>
				<h3>CNIC No: {{$bookiss->cnic}}</h3>
