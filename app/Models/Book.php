...
class Book extends Model
{
    ...
    public function bookserial(){
        return $this->hasMany(BookSerial::class,'book_id','id');
    ...
    public function authers(){
        return $this->belongsToMany(Auther::class,'authorbooks','book_id','auther_id');

    }

     public function shelves(){
        return $this->belongsToMany(Shelf::class,'shelfbooks','book_id','shelf_id');
